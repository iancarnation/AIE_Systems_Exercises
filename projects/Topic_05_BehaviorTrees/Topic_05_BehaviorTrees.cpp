#include "Topic_05_BehaviorTrees.h"
#include "Gizmos.h"
#include "Utilities.h"
#include <GL/glew.h>
...
Topic_05_BehaviorTrees::Topic_05_BehaviorTrees()
{
...
bool Topic_05_BehaviorTrees::onCreate(int a_argc, char* a_argv[]) 
{
...
void Topic_05_BehaviorTrees::onUpdate(float a_deltaTime) 
{
...
void Topic_05_BehaviorTrees::onDraw() 
{
...
void Topic_05_BehaviorTrees::onDestroy()
{
...
int main(int argc, char* argv[])
{
	...
	Application* app = new Topic_05_BehaviorTrees();
	
	if (app->create("AIE - Topic_05_BehaviorTrees",DEFAULT_SCREENWIDTH,DEFAULT_SCREENHEIGHT,argc,argv) == true)
		app->run();
